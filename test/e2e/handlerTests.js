...
describe('Meetup Sample', function () {
    ...
    context('LaunchRequest', function () {
        ...
        it('should return outputSpeech matching string', function () {
            expect(done.response.outputSpeech.ssml).to.have.string('can share drugs and maybe do other things.  For more details, say help. So, what would you like? </speak>');
        });
    ...
    context('ScheduleDrugInfoIntent (newSession: true)', function () {
        let done, err;
        ...
        before(function (cb) {
            ...
            lambdalocal.setLogger(winston);
            const lambda = require('../../src/main.js');
            let event = getEvent('ScheduleDrugInfoIntent.json', true);
        ...
        it('should return outputSpeech matching string', function () {
            expect(done.response.outputSpeech.ssml).to.have.string('<speak> Drug 4: Alexa is my friend  </speak>');
        });
        ...
        it('should return visitedDrugIndexes equal to [3]', function () {
            expect(done.sessionAttributes.visitedDrugIndexes).to.deep.equal([3]);
        });

    });

    context('ScheduleDrugInfoIntent (newSession: false)', function () {
        let done, err;
        ...
        before(function (cb) {
            ...
            lambdalocal.setLogger(winston);
            const lambda = require('../../src/main.js');
            let event = getEvent('ScheduleDrugInfoIntent.json', false);
        ...
        it('should return outputSpeech matching string', function () {
            expect(done.response.outputSpeech.ssml).to.have.string('<speak> Drug 4: Alexa is my friend');
        });
    ...
    context('GetDrugInfoIntent (newSession: true)', function () {
        let done, err;
        ...
        before(function (cb) {
            ...
            lambdalocal.setLogger(winston);
            const lambda = require('../../src/main.js');
            let event = getEvent('GetDrugInfoIntent.json', true);
        ...
        it('should return outputSpeech matching string', function () {
            expect(done.response.outputSpeech.ssml).to.have.string('<speak> Drug ');
        });
        ...
        it('should have card title starts with Drug', function () {
            expect(done.response.card.title).to.have.string('Drug ');
        });
        ...
        it('should return visitedDrugIndexes with one item', function () {
            expect(done.sessionAttributes.visitedDrugIndexes.length).to.equal(1);
        });

    });

    context('GetDrugInfoIntent (newSession: false)', function () {
        let done, err;
        ...
        before(function (cb) {
            ...
            lambdalocal.setLogger(winston);
            const lambda = require('../../src/main.js');
            let event = getEvent('GetDrugInfoIntent.json', false);
        ...
        it.skip('should return visitedDrugIndexes with one item', function () {
            expect(done.sessionAttributes.visitedDrugIndexes.length).to.equal(1);
        });
    });
