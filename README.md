...
```bash
$ npm run configure -- --skillName 'Fun Drugs' --skillNamespace 'organization-skillname' --region 'us-east-1'
```
...
{ "name": [
        ...
        { "description": [
            "Used to aid sleep.",
            "Used to treat heart failure or abnormal heart rhythms.",
            "Used to reduce the risk of blood clots or to improve blood flow.",
            "Used to treat mild to moderate pain, and also to reduce fever or inflammation."
          ]}